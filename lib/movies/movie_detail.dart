...
class MovieDetailPage extends StatelessWidget {
  ...
  List<Widget> _buildGenre(List<int> genre, context) {
    ...
    for(var i=0; i< genre.length; i++) {
      genreList.add(Container(
        ...
        child: Text(Utils.getGenreString(genre[i]),style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
      ));
    }
    return genreList;
  }
  ...
  Widget build(BuildContext context) {
    ...
    final imagePath = movie.backdropPath == null ? 'https://cdn.bodybigsize.com/wp-content/uploads/2020/02/noimage-12.png' : 'http://image.tmdb.org/t/p/w${500}${movie.backdropPath!}';
    final posterPath = movie.posterPath == null ? 'https://cdn.bodybigsize.com/wp-content/uploads/2020/02/noimage-12.png' : 'http://image.tmdb.org/t/p/w${500}${movie.posterPath!}';
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("${movie.releaseDate.toString().split(" ")[0]}", style: textTheme.bodyText2,),
                  SizedBox(height: 16,),
